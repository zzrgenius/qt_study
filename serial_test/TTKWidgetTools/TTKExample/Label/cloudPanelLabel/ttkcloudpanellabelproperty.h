#ifndef TTKCLOUDPANELLABELPROPERTY_H
#define TTKCLOUDPANELLABELPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKCloudPanelLabelProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKCLOUDPANELLABELPROPERTY_H
